...
![Topology Layout](./screenshots/NAT-ROUTER-TOPOLOGY.png)
...
![GNS3 Topology](./screenshots/NAT-ROUTER-TOPOLOGY.png)

---

### 2. NAT Router — show ip interface brief
![IP Interface Brief](./screenshots/ip-int-brief.png)
...
![Interfaces Trunk](./screenshots/int-trunk.png)

---

### 5. NAT Section — show run | section nat
![NAT Config Section](./screenshots/Nat-config-section.png)

---

### 6. NAT Translation Table — show ip nat translations
![NAT Translation Table](./screenshots/ip-nat-trans.png)

---

### 7. Inside Hosts — Successful ping to outside
![PC Success Ping](./screenshots/pc-success-ping.png)

---

### 8. Outside Host — Ping to Router Public IP
![Outside Ping](./screenshots/outside-ping.png)

---

### Additional NAT Statistics
![NAT Stats](./screenshots/nat-stats.png)
